...
;	BSR	MGOT
	...
	JSR	SHOOK
	PUL A
LST41	LDX	$003B		    ; SAVE残りあり？
	CPX	$003D
	BEQ	TOEND
	JSR	SHOOK2
	CLR	FS
TOEND	JMP	END		    ; エディットモードにもどる
*				    ;（リスト処理サブルーチン）
